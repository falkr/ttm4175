...
**From your host PC**, using the command line/Terminal you can access your Raspberry Pi too, using the command `ssh`.

If you are using Windows you may have to download additional software such as Putty: <https://putty.org/>. However, updated versions of Windows 10 should have `ssh` already installed.
