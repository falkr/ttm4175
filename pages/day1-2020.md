...
caption: "NEEDS TO BE UPDATED Each day we try to reach a new goal. The final goal is to run our own website."
---
...
Before continuing with the tasks for today please download the software below.
You can start the downloads and proceed to the next step before they finish.

:steps:
1. Raspbian Virtual Image (large download!): [here!](https://filesender.uninett.no/?s=download&token=b5df913b-dd10-49bb-80b4-0301e70e514e),
2. Virtual Box: <https://www.virtualbox.org/>, and
3. Virtual Box Extensions: <https://www.virtualbox.org/>.
